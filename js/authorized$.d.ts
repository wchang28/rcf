...
export interface I$U {
    (method: restIntf.HTTPMethod, pathname: string, contentInfo: restIntf.ContentInfo, blob: $dr.IReadableBlob, headers?: restIntf.HTTPHeaders): Promise<restIntf.RESTReturn>;
}
